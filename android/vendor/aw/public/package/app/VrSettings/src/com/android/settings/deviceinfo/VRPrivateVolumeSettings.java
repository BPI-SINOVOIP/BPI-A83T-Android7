 ...
 * storage volume.
 */
public class VRPrivateVolumeSettings extends SettingsPreferenceFragment {
    // TODO: disable unmount when providing over MTP/PTP
    // TODO: warn when mounted read-only

    private static final String TAG = "VRPrivateVolumeSettings";
    ...
    public VRPrivateVolumeSettings() {
    ...
    public static class RenameFragment extends DialogFragment {
        public static void show(VRPrivateVolumeSettings parent, VolumeInfo vol) {
    ...
    public static class ConfirmClearCacheFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    final VRPrivateVolumeSettings target = (VRPrivateVolumeSettings) getTargetFragment();
    ...
    private static class ClearCacheObserver extends IPackageDataObserver.Stub {
        private final VRPrivateVolumeSettings mTarget;
        private int mRemaining;

        public ClearCacheObserver(VRPrivateVolumeSettings target, int remaining) {
            mTarget = target;
