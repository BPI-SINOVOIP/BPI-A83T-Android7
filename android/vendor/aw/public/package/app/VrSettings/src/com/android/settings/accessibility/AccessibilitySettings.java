...
public class AccessibilitySettings extends SettingsPreferenceFragment implements DialogCreatable,
    ...
    private SwitchPreference mGestureScreenshotPreference;
    private SwitchPreference mGestureScreenrecordPreference;
    ...
    private void initializeAllPreferences() {
        ...
        mGestureScreenshotPreference = (SwitchPreference) findPreference(TOGGLE_GESTURE_SCRERNSHOT_PREFERENCE);
        mGestureScreenrecordPreference = (SwitchPreference) findPreference(TOGGLE_GESTURE_SCRERNRECORD_PREFERENCE);
    }
    ...
    private void updateSystemPreferences() {
        ...
        if(mGestureScreenshotPreference != null) {
            mGestureScreenshotPreference.setChecked(Settings.System.getInt(getContentResolver(),
                    Settings.System.GESTURE_SCREENSHOT_ENABLE, 0) != 0);
        }
        if(mGestureScreenrecordPreference != null) {
            mGestureScreenrecordPreference.setChecked(Settings.System.getInt(getContentResolver(),
                    Settings.System.GESTURE_SCREENRECORD_ENABLE, 0) != 0);
        }
    }
