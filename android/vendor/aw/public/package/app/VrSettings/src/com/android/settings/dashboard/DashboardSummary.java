...
public class DashboardSummary extends InstrumentedFragment
    ...
    public void onWindowFocusChanged(boolean hasWindowFocus) {
        ...
        if (mDashboard != null && mDashboard.isFocused()) {
            mDashboard.clearFocus();
            mDashboard.setFocusable(false);
            mDashboard.setFocusableInTouchMode(false);
        }
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        mDashboard.setLayoutManager(mStaggeredGridLayoutManager);
