 ...
 */
public class VRDevelopmentSettings extends RestrictedSettingsFragment
        implements DialogInterface.OnClickListener, DialogInterface.OnDismissListener,
                OnPreferenceChangeListener, SwitchBar.OnSwitchChangeListener, Indexable {
    private static final String TAG = "VRDevelopmentSettings";
    ...
    private static final String HIDE_PREFERENCE_KEY = "hide_preference_screen";
    ...
    public void onCreate(Bundle icicle) {
        ...
        addPreferencesFromResource(R.xml.vr_development_prefs);
        ...
        PreferenceScreen hidePreference = (PreferenceScreen)
                findPreference(HIDE_PREFERENCE_KEY);
        if (hidePreference != null) {
            getPreferenceScreen().removePreference(hidePreference);
        }
    }
    ...
    public static final Indexable.SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider() {
                ...
                private boolean isShowingDeveloperOptions(Context context) {
                    return context.getSharedPreferences(VRDevelopmentSettings.PREF_FILE,
                            Context.MODE_PRIVATE).getBoolean(
                                    VRDevelopmentSettings.PREF_SHOW,
