...
import static android.provider.Settings.System.PSENSOR_SCREEN_OFF_TIMEOUT;

import static com.android.settingslib.RestrictedLockUtils.EnforcedAdmin;

public class VRDisplaySettings extends SettingsPreferenceFragment implements
        Preference.OnPreferenceChangeListener, Indexable {
    private static final String TAG = "VRDisplaySettings";
    ...
    private static final String KEY_BRIGHT_SCREEN = "brightness";
    ...
    private PreferenceScreen mBrightnessPreference;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.vr_display_settings);
        mBrightnessPreference = (PreferenceScreen)findPreference(KEY_BRIGHT_SCREEN);
    ...
    public void onResume() {
        ...
        final long currentTimeout = Settings.System.getLong(getActivity().getContentResolver(),
                PSENSOR_SCREEN_OFF_TIMEOUT, FALLBACK_SCREEN_TIMEOUT_VALUE);
    ...
    public boolean onPreferenceChange(Preference preference, Object objValue) {
        ...
        if (KEY_SCREEN_TIMEOUT.equals(key)) {
            try {
                ...
                Settings.System.putInt(getContentResolver(), PSENSOR_SCREEN_OFF_TIMEOUT, value);
