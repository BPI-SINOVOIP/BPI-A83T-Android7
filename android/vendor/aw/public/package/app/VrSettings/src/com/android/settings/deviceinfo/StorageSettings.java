...
public class StorageSettings extends SettingsPreferenceFragment implements Indexable {
    ...
    private void refresh() {
        ...
        if (mInternalCategory.getPreferenceCount() == 2
            ...
            VRPrivateVolumeSettings.setVolumeSize(args, sTotalInternalStorage);
            Intent intent = Utils.onBuildStartFragmentIntent(getActivity(),
                    VRPrivateVolumeSettings.class.getName(), args, null, R.string.apps_storage, null,
                    false);
    ...
    public boolean onPreferenceTreeClick(Preference pref) {
        ...
        if (pref instanceof StorageVolumePreference) {
            ...
            if (vol.getType() == VolumeInfo.TYPE_PRIVATE) {
                ...
                VRPrivateVolumeSettings.setVolumeSize(args, getTotalSize(vol));
                startFragment(this, VRPrivateVolumeSettings.class.getCanonicalName(),
                        -1, 0, args);
                return true;
