...
public class VRDeviceInfoSettings extends SettingsPreferenceFragment implements Indexable {
    ...
    public void onCreate(Bundle icicle) {
        ...
        addPreferencesFromResource(R.xml.vr_device_info_settings);
        ...
        if (findPreference(KEY_BUILD_NUMBER) != null) {
