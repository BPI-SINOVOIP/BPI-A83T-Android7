...
#define MTOP_VERSION "0.7"
#define MTOP_UPDATE  "2017-04-25"
...
static void version(void) {
    ...
    fprintf(stdout, "latest update date: %s\n", MTOP_UPDATE);
    fprintf(stdout, "\n");
}
...
int main(int argc, char *argv[]) {
    ...
    if (!strcmp(hardware, "sun9i")) {
        ...
        nodeInfo = nodeInfo_sun9i;
        nodeUnit = nodeUnit_sun9i;
    } else if ((!strcmp(hardware, "sun8iw5p1")) || (!strcmp(hardware, "sun8iw6p1")) \
                || (!strcmp(hardware, "sun8i"))) {
        nhardware = 1;
