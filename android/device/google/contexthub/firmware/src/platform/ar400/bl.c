...
{
    //const uint32_t intInPin = SH_INT_WAKEUP - GPIO_PM(0);//FIXME
    const uint32_t intInPin = 0;
...
#if 0
    if (SH_INT_WAKEUP < GPIO_PM(0) || SH_INT_WAKEUP > GPIO_PM(15)) {
