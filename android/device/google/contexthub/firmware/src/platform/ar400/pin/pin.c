...
int pin_init(void)
{
	...
	writel(0x1, PIN_REG_INT_DEBOUNCE(PIN_GRP_PL));
	writel(0x1, PIN_REG_INT_DEBOUNCE(PIN_GRP_PM));
...
*********************************************************************************************************
*/
int pin_set_status(u32 pin_grp, u32 pin_num, struct pin_status *pstatus)
{
	return OK;
}
...
*********************************************************************************************************
*/
int pin_set_multi_sel(u32 pin_grp, u32 pin_num, u32 multi_sel)
{
	volatile u32 *addr;
	volatile u32  value;
...
*********************************************************************************************************
*/
int pin_set_pull(u32 pin_grp, u32 pin_num, u32 pull)
{
	volatile u32 *addr;
	volatile u32  value;
...
*********************************************************************************************************
*/
int pin_set_drive(u32 pin_grp, u32 pin_num, u32 drive)
{
	volatile u32 *addr;
	volatile u32  value;
...
*********************************************************************************************************
*/
int pin_write_data(u32 pin_grp, u32 pin_num, u32 data)
{
	volatile u32 *addr;
	volatile u32  value;
