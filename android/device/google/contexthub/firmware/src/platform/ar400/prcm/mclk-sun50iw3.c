...
static s32 calc_clk_ratio_nm(u32 div, u32 *n, u32 *m);
...
s32 ccu_set_mclk_src(u32 mclk, u32 sclk)
{
	switch (mclk)
	{
		...
		case CCU_MOD_CLK_SYSTICK:
		{
			switch(sclk)
			{
				case CCU_SYS_CLK_LOSC:
				{
					ccu_reg_addr->systick_clk_cfg.src_sel = 0;
					return OK;
				}
				case CCU_SYS_CLK_IOSC:
				{
					ccu_reg_addr->systick_clk_cfg.src_sel = 1;
					return OK;
				}
				case CCU_SYS_CLK_HOSC:
				{
					ccu_reg_addr->systick_clk_cfg.src_sel = 2;
					return OK;
				}
				default:
				{
		...
		case CCU_MOD_CLK_APBS2:
		{
			...
			notifier_notify(&apbs2_notifier_head, CCU_CLK_CLKCHG_REQ, src_freq / ccu_get_mclk_div(CCU_MOD_CLK_APBS2));
			ccu_reg_addr->apbs2_cfg.factor_m = factor_m;
			udelay(2);
			ccu_reg_addr->apbs2_cfg.src_sel = src_sel;
			notifier_notify(&apbs2_notifier_head, CCU_CLK_CLKCHG_DONE, src_freq / ccu_get_mclk_div(CCU_MOD_CLK_APBS2));

			//printk("%p:%x\n", (void *)(&(ccu_reg_addr->apbs2_cfg)), *((u32 *)(&(ccu_reg_addr->apbs2_cfg))));
			return OK;
			...
			switch(sclk)
			{
				case CCU_SYS_CLK_HOSC:
				{
					writel(((readl(CCU_CPU_AXI_CFG_REG) & (~(0x3 << 24)))
											   | (0x0 << 24)), CCU_CPU_AXI_CFG_REG);
					return OK;
				}
				case CCU_SYS_CLK_LOSC:
				{
					writel(((readl(CCU_CPU_AXI_CFG_REG) & (~(0x3 << 24)))
											   | (0x1 << 24)), CCU_CPU_AXI_CFG_REG);
					return OK;
				}
				case CCU_SYS_CLK_IOSC:
				{
					writel(((readl(CCU_CPU_AXI_CFG_REG) & (~(0x3 << 24)))
											   | (0x2 << 24)), CCU_CPU_AXI_CFG_REG);
					return OK;
				}
				case CCU_SYS_CLK_PLL1:
				{
					writel(((readl(CCU_CPU_AXI_CFG_REG) & (~(0x3 << 24)))
											   | (0x3 << 24)), CCU_CPU_AXI_CFG_REG);
					return OK;
				}
				default:
				{
		...
		case CCU_MOD_CLK_AHB2:
		{
			switch(sclk)
			{
				case CCU_SYS_CLK_HOSC:
				{
					writel(((readl(CCU_PSI_AHB1_AHB2_CFG_REG) & (~(0x3 << 24)))
											   | (0x0 << 24)), CCU_PSI_AHB1_AHB2_CFG_REG);
					return OK;
				}
				case CCU_SYS_CLK_LOSC:
				{
					writel(((readl(CCU_PSI_AHB1_AHB2_CFG_REG) & (~(0x3 << 24)))
											   | (0x1 << 24)), CCU_PSI_AHB1_AHB2_CFG_REG);
					return OK;
				}
				case CCU_SYS_CLK_IOSC:
				{
					writel(((readl(CCU_PSI_AHB1_AHB2_CFG_REG) & (~(0x3 << 24)))
											   | (0x2 << 24)), CCU_PSI_AHB1_AHB2_CFG_REG);
					return OK;
				}
				case CCU_SYS_CLK_PLL5:
				{
					writel(((readl(CCU_PSI_AHB1_AHB2_CFG_REG) & (~(0x3 << 24)))
											   | (0x3 << 24)), CCU_PSI_AHB1_AHB2_CFG_REG);
					return OK;
				}
				default:
				{
		...
		case CCU_MOD_CLK_AHB3:
		{
			switch(sclk)
			{
				case CCU_SYS_CLK_HOSC:
				{
					writel(((readl(CCU_AHB3_CFG_REG) & (~(0x3 << 24)))
											   | (0x0 << 24)), CCU_AHB3_CFG_REG);
					return OK;
				}
				case CCU_SYS_CLK_LOSC:
				{
					writel(((readl(CCU_AHB3_CFG_REG) & (~(0x3 << 24)))
											   | (0x1 << 24)), CCU_AHB3_CFG_REG);
					return OK;
				}
				case CCU_SYS_CLK_PSI:
				{
					writel(((readl(CCU_AHB3_CFG_REG) & (~(0x3 << 24)))
											   | (0x2 << 24)), CCU_AHB3_CFG_REG);
					return OK;
				}
				case CCU_SYS_CLK_PLL5:
				{
					writel(((readl(CCU_AHB3_CFG_REG) & (~(0x3 << 24)))
											   | (0x3 << 24)), CCU_AHB3_CFG_REG);
					return OK;
				}
				default:
				{
			...
			switch(sclk)
			{
				case CCU_SYS_CLK_HOSC:
				{
					writel(((readl(CCU_APB1_CFG_REG) & (~(0x3 << 24)))
											   | (0x0 << 24)), CCU_APB1_CFG_REG);
					return OK;
				}
				case CCU_SYS_CLK_LOSC:
				{
					writel(((readl(CCU_APB1_CFG_REG) & (~(0x3 << 24)))
											   | (0x1 << 24)), CCU_APB1_CFG_REG);
					return OK;
				}
				case CCU_SYS_CLK_PSI:
				{
					writel(((readl(CCU_APB1_CFG_REG) & (~(0x3 << 24)))
											   | (0x2 << 24)), CCU_APB1_CFG_REG);
					return OK;
				}
				case CCU_SYS_CLK_PLL5:
				{
					writel(((readl(CCU_APB1_CFG_REG) & (~(0x3 << 24)))
											   | (0x3 << 24)), CCU_APB1_CFG_REG);
					return OK;
				}
				default:
				{
			...
			switch(sclk)
			{
				case CCU_SYS_CLK_HOSC:
				{
					writel(((readl(CCU_APB2_CFG_REG) & (~(0x3 << 24)))
											   | (0x0 << 24)), CCU_APB2_CFG_REG);
					return OK;
				}
				case CCU_SYS_CLK_LOSC:
				{
					writel(((readl(CCU_APB2_CFG_REG) & (~(0x3 << 24)))
											   | (0x1 << 24)), CCU_APB2_CFG_REG);
					return OK;
				}
				case CCU_SYS_CLK_PSI:
				{
					writel(((readl(CCU_APB2_CFG_REG) & (~(0x3 << 24)))
											   | (0x2 << 24)), CCU_APB2_CFG_REG);
					return OK;
				}
				case CCU_SYS_CLK_PLL5:
				{
					writel(((readl(CCU_APB2_CFG_REG) & (~(0x3 << 24)))
											   | (0x3 << 24)), CCU_APB2_CFG_REG);
					return OK;
				}
				default:
				{
		...
		case CCU_MOD_CLK_R_CIR:
		{
			switch(sclk)
			{
				...
				{
					ccu_reg_addr->r_ir_clk.sclk_gate = 0;
					return OK;
				}
				case CCU_SYS_CLK_LOSC:
				{
					ccu_reg_addr->r_ir_clk.src_sel = 0;
					ccu_reg_addr->r_ir_clk.sclk_gate = 1;
					return OK;
				}
				case CCU_SYS_CLK_HOSC:
				{
		...
		case CCU_MOD_CLK_R_SPI:
		{
			switch(sclk)
			{
				case CCU_SYS_CLK_APBS1:
				{
					ccu_reg_addr->r_spi_clk.sclk_gate = 0;
					return OK;
				}
				case CCU_SYS_CLK_HOSC:
				{
					ccu_reg_addr->r_spi_clk.src_sel = 0;
					ccu_reg_addr->r_spi_clk.sclk_gate = 1;
					return OK;
				}
				case CCU_SYS_CLK_PLL_PERI0_1X:
				{
					ccu_reg_addr->r_spi_clk.src_sel = 1;
					ccu_reg_addr->r_spi_clk.sclk_gate = 1;
					return OK;
				}
				case CCU_SYS_CLK_PLL_PERI1_1X:
				{
					ccu_reg_addr->r_spi_clk.src_sel = 2;
					ccu_reg_addr->r_spi_clk.sclk_gate = 1;
					return OK;
				}
				case CCU_SYS_CLK_PLL_PERI0_2X:
				{
					ccu_reg_addr->r_spi_clk.src_sel = 3;
					ccu_reg_addr->r_spi_clk.sclk_gate = 1;
					return OK;
				}
				case CCU_SYS_CLK_PLL_PERI1_2X:
				{
					ccu_reg_addr->r_spi_clk.src_sel = 4;
					ccu_reg_addr->r_spi_clk.sclk_gate = 1;
					return OK;
				}
				case CCU_SYS_CLK_16M:
				case CCU_SYS_CLK_IOSC:
				{
					ccu_reg_addr->r_spi_clk.src_sel = 5;
					ccu_reg_addr->r_spi_clk.sclk_gate = 1;
					return OK;
				}
				case CCU_SYS_CLK_LOSC:
				{
					ccu_reg_addr->r_spi_clk.src_sel = 6;
					ccu_reg_addr->r_spi_clk.sclk_gate = 1;
					return OK;
				}
				default:
	...
	switch (mclk)
	{
		...
		case CCU_MOD_CLK_AHB2:
		{
			switch((readl(CCU_PSI_AHB1_AHB2_CFG_REG) >> 24) & 0x3)
			{
				...
				default:
				{
					//invalid value for module clock
					return -EINVAL;
				}
			}
		}
		case CCU_MOD_CLK_AHB3:
		{
			switch((readl(CCU_AHB3_CFG_REG) >> 24) & 0x3)
			{
				case 0:
				{
					return CCU_SYS_CLK_HOSC;
		...
		case CCU_MOD_CLK_R_CIR:
		{
			if (ccu_reg_addr->r_ir_clk.sclk_gate == 0)
				return CCU_SYS_CLK_APBS1;
			else {
		...
		{
			if (ccu_reg_addr->r_owc_clk.sclk_gate == 0)
				return CCU_SYS_CLK_APBS1;
			switch (ccu_reg_addr->r_owc_clk.src_sel)
			{
				case 0:
				{
					return CCU_SYS_CLK_LOSC;
		...
		case CCU_MOD_CLK_R_SPI:
		{
			if (ccu_reg_addr->r_spi_clk.sclk_gate == 0)
				return CCU_SYS_CLK_APBS1;
			else {
				switch (ccu_reg_addr->r_spi_clk.src_sel)
				{
					...
					case 1:
					{
						return CCU_SYS_CLK_PLL_PERI0_1X;
					}
					case 2:
					{
						return CCU_SYS_CLK_PLL_PERI1_1X;
					}
					case 3:
					{
						return CCU_SYS_CLK_PLL_PERI0_2X;
					}
					case 4:
					{
						return CCU_SYS_CLK_PLL_PERI1_2X;
					}
					case 5:
					{
						return CCU_SYS_CLK_IOSC;
...
s32 ccu_set_mclk_div(u32 mclk, u32 div)
{
	switch (mclk)
	{
		case CCU_MOD_CLK_CPUS:
		{
			ccu_reg_addr->cpus_clk_cfg.factor_n = ccu_log2(div);
			return OK;
		}
		case CCU_MOD_CLK_APBS1:
		{
		...
		case CCU_MOD_CLK_R_SPI:
		{
			...
			ccu_reg_addr->r_spi_clk.factor_n = ccu_log2(factor_n);
			ccu_reg_addr->r_spi_clk.factor_m = factor_m - 1;
			return OK;
		}
		...
		case CCU_MOD_CLK_AHB3:
		{
			...
			value = readl(CCU_AHB3_CFG_REG);
			value &= (~(0x3ff << 0));
			value |= (ccu_log2(factor_n) << 8) | (factor_m - 1);
			writel(value, CCU_AHB3_CFG_REG);
	...
	switch (mclk)
	{
		...
		case CCU_MOD_CLK_R_SPI:
		{
			if (ccu_reg_addr->r_spi_clk.sclk_gate == 0)
				...
				return (1 << (ccu_reg_addr->r_spi_clk.factor_n)) *
					(ccu_reg_addr->r_spi_clk.factor_m + 1);
			}
		}
		case CCU_MOD_CLK_AXI:
		{
...
s32 ccu_set_mclk_onoff(u32 mclk, s32 onoff)
{
	switch (mclk)
	{
		...
		{
			ccu_reg_addr->r_twi.twi0_gate = onoff;
			return OK;
		}
		case CCU_MOD_CLK_R_TWI1:
		{
			ccu_reg_addr->r_twi.twi1_gate = onoff;
			return OK;
		}
		case CCU_MOD_CLK_R_TWI2:
		{
			ccu_reg_addr->r_twi.twi2_gate = onoff;
			return OK;
		}
		case CCU_MOD_CLK_R_UART:
		{
