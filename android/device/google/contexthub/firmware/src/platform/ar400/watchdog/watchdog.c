...
s32 watchdog_init(void)
{
	...
	pwatchdog_regs->config |= WDOG0_RST_INT;
...
*                                       WATCHDOG PING
*
* Description:  watchdog ping.
*
* Arguments  :  none.
*
* Returns    :  OK if watchdog ping succeeded, others if failed.
*********************************************************************************************************
*/
s32 watchdog_ping(void)
{
	//watchdog0 ping
	pwatchdog_regs->config = WDOG0_KEY_FIELD | WDOG0_RESTART;
