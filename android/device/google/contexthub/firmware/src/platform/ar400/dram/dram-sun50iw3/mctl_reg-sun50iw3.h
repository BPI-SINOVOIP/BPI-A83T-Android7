...
#define MCTL_COM_BASE               0xd4002000
#define MCTL_CTL_BASE               0xd4003000
...
#define MC_Mn_BWLR(x)				(MCTL_COM_BASE + 0x218 + 0x10 * x)
/*protect register*/
 ...
 * ====================================
 */
#define _CCM_BASE					0xd3001000
#define _PLL_DDR0_CTRL_REG         	(_CCM_BASE+0x10)
#define _PLL_DDR1_CTRL_REG         	(_CCM_BASE+0x18)
#define PLL_DDR0_PAT_CTL_REG		(_CCM_BASE+0x110)
#define PLL_DDR1_PAT_CTL_REG		(_CCM_BASE+0x118)
#define _MBUS_CFG_REG              	(_CCM_BASE+0x540)
#define _DMA_BGR_REG				(_CCM_BASE+0x70C)
...
/* PRCM */
/*PAD HOLD CONTROL */
#define R_PRCM_BASE                	(0xd7010000)
#define VDD_SYS_PWROFF_GATING_REG	(R_PRCM_BASE + 0x250)
#define RES_CAL_CTRL_REG			(R_PRCM_BASE + 0x310)
#define RES240_MAN_CTRL_REG			(R_PRCM_BASE + 0x318)

/*SYSCTRL */
/* RAM BIST CONTROL */
#define SYS_CFG_BASE				(0xd3000000)
