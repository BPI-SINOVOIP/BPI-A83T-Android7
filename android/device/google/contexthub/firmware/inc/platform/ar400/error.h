...
//the hwmsgbox fifo is full, can't send message
#define ERR_HWMSGBOX_FIFO_FULL  (0x100)
...
#if defined CONFIG_ARCH_SUN8IW1P1
#define RTC_RECORD_REG   (0x01f00114)
#elif (defined CONFIG_ARCH_SUN8IW3P1) || \
	(defined CONFIG_ARCH_SUN8IW5P1) || \
	(defined CONFIG_ARCH_SUN8IW9P1) || \
	(defined CONFIG_ARCH_SUN50IW1P1) || \
	(defined CONFIG_ARCH_SUN50IW2P1)
#define RTC_RECORD_REG   (0x01f0010c)
...
#define RTC_RECORD_REG   (RTC_REG_BASE + 0x10c)
#define RTC_SH_WAKEUP_AP_REG   (RTC_REG_BASE + 0x110)
#define RTC_AP_WAKEUP_SH_REG   (RTC_REG_BASE + 0x114)
#define START_OS_REG     (RTC_DM_REG2)
#endif
...
#define RTC_RECORD_REG   RTC_DM_REG2

#define REC_SSTANDBY     (0)
#define REC_NSTANDBY     (0)
#define REC_ESTANDBY     (0)
#define REC_FAKEPOWEROFF (0)
#define REC_TSTANDBY     (0)

//standby progress record
//macro record
#define REC_COPY_DONE     (0x00)
#define REC_ENTER         (0x10)
#define REC_BEFORE_INIT   (0x20)
#define REC_ENTER_INIT    (0x30)
#define REC_AFTER_INIT    (0x40)
#define REC_WAIT_WAKEUP   (0x50)
#define REC_BEFORE_EXIT   (0x60)
#define REC_ENTER_EXIT    (0x70)
#define REC_AFTER_EXIT    (0x80)
#define REC_DRAM_DBG      (0x90)
#define REC_SHUTDOWN      (0xa0)
#define REC_HOTPULG       (0xb0)
#define REC_CPUX_RESUME   (0xc0)
#define REC_DEBUG         (0xd0)
#define REC_CPUS_LOOP     (0xe0)
