...
#include "./platform-sun8iw1p1.h"
#elif defined CONFIG_ARCH_SUN8IW3P1
#include "./platform-sun8iw3p1.h"
#elif defined CONFIG_ARCH_SUN8IW5P1
#include "./platform-sun8iw5p1.h"
#elif defined CONFIG_ARCH_SUN8IW6P1
#include "./platform-sun8iw6p1.h"
#elif defined CONFIG_ARCH_SUN8IW7P1
#include "./platform-sun8iw7p1.h"
#elif defined CONFIG_ARCH_SUN8IW8P1
#include "./platform-sun8iw8p1.h"
#elif defined CONFIG_ARCH_SUN8IW9P1
#include "./platform-sun8iw9p1.h"
#elif defined(CONFIG_ARCH_SUN9IW1P1)
#include "./platform-sun9iw1p1.h"
#elif defined(CONFIG_ARCH_SUN50IW1P1)
#include "./platform-sun50iw1p1.h"
#elif defined(CONFIG_ARCH_SUN50IW2P1)
#include "./platform-sun50iw2p1.h"
#elif defined(CONFIG_ARCH_SUN50IW3P1)
#include "./platform-sun50iw3p1.h"
