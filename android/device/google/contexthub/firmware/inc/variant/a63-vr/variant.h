...
#define PLATFORM_HOST_INTF_SHAREMEM_BUS 0

//#define SH_INT_WAKEUP               GPIO_PM(0)
#define SH_EXTI_WAKEUP_IRQ          EXTI0_IRQn
//#define AP_INT_WAKEUP               GPIO_PM(1)
...
#define HALL_PIN        GPIO_PL(5)
#define HALL_IRQ        R_GPIOL_IRQn
