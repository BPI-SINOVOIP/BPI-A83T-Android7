...
PRODUCT_COPY_FILES += \
    ...
    device/softwinner/bpi-m3-hdmi/fstab.sun8iw6p1:root/fstab.sun8iw6p1 \
    device/softwinner/bpi-m3-hdmi/init.device.rc:root/init.device.rc \
    ...
    device/softwinner/bpi-m3-hdmi/modules/modules/auto_detect.ko:recovery/root/auto_detect.ko \
    device/softwinner/bpi-m3-hdmi/modules/modules/gslX680new.ko:recovery/root/gslX680new.ko \


#BPI-M3 Porting 
   PRODUCT_COPY_FILES += \
	device/softwinner/bpi-m3-hdmi/configs/bluetooth/bt_vendor.conf:system/etc/bluetooth/bt_vendor.conf
...
PRODUCT_COPY_FILES += \
    ...
    device/softwinner/bpi-m3-hdmi/configs/wifi_efuse_8723bs-vq0.map:system/etc/wifi/wifi_efuse_8723bs-vq0.map
...
PRODUCT_COPY_FILES += \
    ...
    #device/softwinner/bpi-m3-hdmi/media/audio_conf.txt:system/media/audio_conf.txt \
    #device/softwinner/bpi-m3-hdmi/media/boot.wav:system/media/boot.wav
