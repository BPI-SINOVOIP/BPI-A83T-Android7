...
public class Launcher extends Activity
    ...
    private static final int HOME=0x000f0000;
    private static final int NORMAL=0x00000f00;
    ...
    class BoostUPerfTimerTask extends TimerTask {
        public void run() {
            try {
                Method method = PowerManager.class.getMethod("powerHint",int.class,int.class);
                method.invoke(mPowerManager,HOME,2);
                mBoostUperfHomeEnter = true;
            } catch (Exception e) {
                Log.e(TAG,"invoke powerHint() failed");
            }
        }
    }
    ...
    private void cancelTimer_boostUperf() {
        ...
        if (mBoostUperfHomeEnter) {
            try {
                Method method = PowerManager.class.getMethod("powerHint",int.class,int.class);
                method.invoke(mPowerManager,NORMAL,1);
                mBoostUperfHomeEnter = false;
            } catch (Exception e) {
                Log.e(TAG,"invoke powerHint() error");
            }
        }
    }
