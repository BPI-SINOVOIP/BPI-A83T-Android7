    ...
    if (ev.type == EV_ABS) {
        switch(ev.code) {
            ...
            case ABS_MT_POSITION_X:
                if (ev.value != 0) {
                    if (90 == rotation) current_y = gr_fb_height() - ev.value;
                    else if (270 == rotation) current_y = ev.value;
                    event_count++;
                }
                break;
            ...
            case ABS_MT_POSITION_Y:
                if (ev.value != 0) {
                    if (180 == rotation) current_y = gr_fb_height() - ev.value;
                    else current_y = ev.value;
                    event_count++;
                }
                break;
