...
ifneq ($(BOARD_POWER_ON_KEY_TIME),)
LOCAL_CFLAGS += -DBOARD_POWER_ON_KEY_TIME=$(BOARD_POWER_ON_KEY_TIME)
endif
ifneq ($(BOARD_UNPLUGGED_SHUTDOWN_TIME),)
LOCAL_CFLAGS += -DBOARD_UNPLUGGED_SHUTDOWN_TIME=$(BOARD_UNPLUGGED_SHUTDOWN_TIME)
endif
LOCAL_SRC_FILES := \
