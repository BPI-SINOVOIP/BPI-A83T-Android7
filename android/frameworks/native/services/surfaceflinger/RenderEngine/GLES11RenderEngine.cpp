...
void GLES11RenderEngine::drawBackground(){

}
void GLES11RenderEngine::drawForground(){

}

void GLES11RenderEngine::enableVrDesktop(bool enable){
    mVrDesktopEnable = enable;
}

#define UNUSED(a) do {__typeof__ (&a) __attribute__ ((unused)) __tmp = &a; } while(0)
void GLES11RenderEngine::sendControllerData(int status, int needRecenter,
...
void GLES11RenderEngine::recenterOrientation(){}

void GLES11RenderEngine::bufferChange(bool change){
    UNUSED(change);
}

void GLES11RenderEngine::bufferDestroy(int textureName) {
    UNUSED(textureName);
}
