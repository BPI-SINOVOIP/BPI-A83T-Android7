...
public:
    ...
    bool mVrDesktopEnable = false;
    virtual void drawBackground() = 0;
    virtual void enableVrDesktop(bool enable) = 0;
    virtual void drawForground() = 0;
    virtual void sendControllerData(int status, int needRecenter,
        float x, float y, float z, float w, float l) = 0;
    virtual void recenterOrientation() = 0;
    virtual void bufferChange(bool change) = 0;
    virtual void bufferDestroy(int textureName) = 0;
};
