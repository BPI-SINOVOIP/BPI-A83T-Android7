...
public:
    ...
    /* Get the controller data to vrdesktop. */
    virtual void sendControllerData(int status, int needRecenter, float x, float y, float z, float w, float l) = 0;
    virtual int sendDispalyData(int disp, int cmd, int val0, int val1) = 0;
};
