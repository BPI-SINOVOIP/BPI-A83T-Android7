...
status_t ACodec::setupVideoEncoder(
    ...
    if (!msg->findInt32("src-width", &srcWidth)) {
        //srcWidth = width;
        ALOGD("srcWidth: %d", srcWidth);
    }

    if (!msg->findInt32("src-height", &srcHeight)) {
        //srcHeight = height;
        ALOGD("srcHeight: %d", srcHeight);
    }
    ...
    if(srcWidth != 0 && srcHeight != 0) {
        ...
        ALOGD("xxx video_def->nFrameWidth: %d, video_def->nFrameHeight: %d", video_def->nFrameWidth, video_def->nFrameHeight);
    }
