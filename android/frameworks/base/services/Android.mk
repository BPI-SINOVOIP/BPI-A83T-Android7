...
ifeq ($(TARGET_USE_BOOSTUP_OPZ), true)
LOCAL_SRC_FILES := $(call all-java-files-under,java_opt)
else
...
LOCAL_ADDITIONAL_DEPENDENCIES := vendor/aw/public/prebuild/lib/libapphub/Android.mk
LOCAL_STATIC_JAVA_LIBRARIES := $(addprefix services.,$(services)) apphub
