...
public class UsbDeviceManager {
    ...
    private boolean mUsbConnectedDataUnlocked;
    ...
    public void systemReady() {
        ...
        mUsbConnectedDataUnlocked = mContext.getResources().getBoolean(
                com.android.internal.R.bool.config_usbConnectedDataUnlocked);
            ...
            switch (msg.what) {
                case MSG_UPDATE_STATE:
                    ...
                    if (UsbManager.containsFunction(mCurrentFunctions,
                        ...
                        setEnabledFunctions(null, false, false);
                    } else if (mUsbConnectedDataUnlocked) {
