...
public final class SystemServer {
    ...
    private static boolean delayStartComponent;
    ...
    private void run() {
        ...
        delayStartComponent= mSystemContext.getResources().getBoolean(com.android.internal.R.bool.config_delayStartComponent);
        // Start services.
        try {
    ...
    private void startOtherServices() {
        ...
        mActivityManagerService.systemReady(new Runnable() {
            ...
            public void run() {
                ...
                String appId = SystemProperties.get("sys.saturn.appid");
    ...
    static final void startCollection(Context context) {
        String appId = SystemProperties.get("sys.saturn.appid");
        String appSecret = SystemProperties.get("sys.saturn.appsecret");
        com.softwinner.apphub.Apphub apphub = new com.softwinner.apphub.Apphub(context);
        apphub.setAppId(appId);
        apphub.setAppSecret(appSecret);
        apphub.collect();
    }
