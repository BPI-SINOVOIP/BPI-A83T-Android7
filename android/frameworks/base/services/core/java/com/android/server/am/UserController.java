...
import static com.android.server.am.ActivityManagerService.SYSTEM_USER_UNLOCK_BROADCAST_MSG;
...
final class UserController {
    ...
    UserController(ActivityManagerService service) {
        ...
        disableDirectbootBlock=mService.mContext.getResources().getBoolean(com.android.internal.R.bool.config_disableDirectBootBlock);
        ...
        synchronized (mService) {
            ...
            if (uss.setState(STATE_RUNNING_UNLOCKING, STATE_RUNNING_UNLOCKED)) {
                ...
                if(!disableDirectbootBlock) {
                    ...
                    Message msg = mHandler.obtainMessage(SYSTEM_USER_UNLOCK_BROADCAST_MSG, userId, 0);
