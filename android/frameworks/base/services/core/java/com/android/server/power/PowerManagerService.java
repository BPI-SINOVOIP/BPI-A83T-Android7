...
public final class PowerManagerService extends SystemService
    ...
    private boolean goToSleepNoUpdateLocked(long eventTime, int reason, int flags, int uid) {
        ...
        try {
            IBinder b = ServiceManager.getService(BackgroundManager.SERVICE);
            BackgroundManagerService bms = (BackgroundManagerService) IBackgroundManager.Stub.asInterface(b);
            bms.killBackgroundTaskImmediately();
            switch (reason) {
