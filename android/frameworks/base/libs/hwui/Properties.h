...
/** 
 * Controls whether or not HWUI will use the EGL_SWAP_BEHAVIOR_PRESERVED_BIT extension
 * to do partial invalidates.Setting this to "false" will fall back to discass it.
 * Default is "true"
 */
#define PROPERTY_USE_PRESERVE_BUFFERS_ON_SWAP "debug.hwui.use_swap_buffers"
...
public:
    ...
    static bool preserveBuffersOnSwap;
