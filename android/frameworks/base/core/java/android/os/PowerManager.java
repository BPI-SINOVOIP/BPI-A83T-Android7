...
public final class PowerManager {
    ...
    /**
     * bootcomplete mode for scense_control
     * @hide
     */
    public static final int BOOTCOMPLETE=0x00000010;

    /**
     * benchmark mode for scense_control
     * @hide
     */
    public static final int BENCHMARK=0x00000020;

    /**
     * normal  mode for scense_control
     * @hide
     */
    public static final int NORMAL=0x00000030;

    /**
     * music  mode for scense_control
     * @hide
     */
    public static final int MUSIC=0x00000040;

    /**
     * home  mode for scense_control
     * @hide
     */
    public static final int HOME=0x00000050;
    ...
    public void powerHint(int hintId, int data) {
        try {
            mService.powerHint(hintId, data);
