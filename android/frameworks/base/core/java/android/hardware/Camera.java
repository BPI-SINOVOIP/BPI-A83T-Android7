        ...
        public void handleMessage(Message msg) {
            ...
            case CAMERA_MSG_PREVIEW_FRAME:
                ...
                if (pCb != null) {
                    ...
                    if("android.camera.cts".equals(SystemProperties.get("persist.sys.cts"))){
                        Size size = getParameters().getPreviewSize();
                        if(((byte[])msg.obj).length != (size.width * size.height * 12 / 8)){
                            Log.e(TAG,"---------ignore this preview frame----------------------");
                        }else{
