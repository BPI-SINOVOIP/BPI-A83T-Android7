...
public final class Settings {
    ...
    public static final class System extends NameValueTable {
        ...
        /**
         * background services limit count
         * @hide
         */
        public static final String BACKGROUND_SERVICES_LIMIT_COUNT = "background_services_limit_count";
         ...
         *
         * this time out is use for our psensor service
         * @hide
         */
        public static final String PSENSOR_SCREEN_OFF_TIMEOUT = "psensor_screen_off_timeout";

        private static final Validator PSENSOR_SCREEN_OFF_TIMEOUT_VALIDATOR = sNonNegativeIntegerValidator;
        ...
        static {
            ...
            PUBLIC_SETTINGS.add(PSENSOR_SCREEN_OFF_TIMEOUT);
        }
        ...
        static {
            ...
            VALIDATORS.put(PSENSOR_SCREEN_OFF_TIMEOUT, PSENSOR_SCREEN_OFF_TIMEOUT_VALIDATOR);
        }
