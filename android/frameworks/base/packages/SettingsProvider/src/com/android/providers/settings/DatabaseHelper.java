...
class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void loadSystemSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            loadIntegerSetting(stmt, Settings.System.PSENSOR_SCREEN_OFF_TIMEOUT,
                    R.integer.def_psensor_screen_off_timeout);
    ...
    private void loadSecureSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            loadIntegerSetting(stmt, Settings.Secure.VR_DISPLAY_MODE,
                    R.integer.def_vr_display_mode);
    ...
    private void loadGlobalSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            loadIntegerSetting(stmt, Settings.Global.CAPTIVE_PORTAL_USE_HTTPS,
                    R.integer.def_captive_portal_use_https);
            ...
            loadIntegerSetting(stmt, Settings.Global.DEVELOPMENT_FORCE_RESIZABLE_ACTIVITIES,
                    R.integer.def_force_resizable_activities);
