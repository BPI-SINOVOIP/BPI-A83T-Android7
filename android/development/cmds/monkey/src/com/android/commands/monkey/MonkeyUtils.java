...
public abstract class MonkeyUtils {
    ...
    public static class PackageFilter {
        ...
        private Set<String> mDefaultInvalidPackages = new HashSet<>();
        ...
        public void addInvalidPackages(Set<String> invalidPackages) {
            ...
            mDefaultInvalidPackages.clear();
            mDefaultInvalidPackages.add("com.google.android.gms");
            mDefaultInvalidPackages.add("com.google.android.apps.docs");
            mDefaultInvalidPackages.add("com.android.chrome");
            mDefaultInvalidPackages.add("com.google.android.apps.photos");
            mDefaultInvalidPackages.add("com.estrongs.android.pop");
        }
        ...
        public boolean isPackageInvalid(String pkg) {
            return mInvalidPackages.contains(pkg) || mDefaultInvalidPackages.contains(pkg);
        }
        ...
        public boolean checkEnteringPackage(String pkg) {
            if (mInvalidPackages.size() > 0) {
                if (mInvalidPackages.contains(pkg) || mDefaultInvalidPackages.contains(pkg)) {
                    return false;
                }
